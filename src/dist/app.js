...
const animate = () => {
    ...
    for (let index in arr) {
        if (((_a = arr[index]) === null || _a === void 0 ? void 0 : _a.size) <= 0.2)
            arr.splice(+index, 1); // remove particle from array if size is less than or equal 0.2
        (_b = arr[index]) === null || _b === void 0 ? void 0 : _b.draw();
        (_c = arr[index]) === null || _c === void 0 ? void 0 : _c.update();
    }
};
/** FPS */
const prepareFps = () => {
